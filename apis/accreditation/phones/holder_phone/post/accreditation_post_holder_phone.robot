...
criar holder phone
    ...
    ...                         "number": "${phone_number}"
    ...                      }
    ${response}        Post Request        accreditation            /marketplaces/${marketplace_external_key}/banking/accreditation/holders/${holder_external_key}/phones
    ...                                                             data=${body}
    ...                                                             headers=${header}
    ...
    ${phone_external_key}       Set Variable If    ${response.status_code}==201    ${response.json()["id"]}

...
cancelar pagamento pix
    ...
    ${response}        Post Request        pix-payments        /marketplaces/${marketplace_external_key}/banking/pix/holders/${holder_external_key}/accounts/${account_external_key}/payments/${payment_external_key}/cancel
    ...                                                        headers=${header}

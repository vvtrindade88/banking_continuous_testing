...
validar pagamento pix
  [Arguments]  ${transaction_id}  ${marketplace_external_key}  ${status_pix_payments}  ${amount}  ${pix_description}
  ...
  Should Be Equal                 ${response.json()["transaction_id"]}                                  ${transaction_id}
